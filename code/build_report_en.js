...
c.push(bulletm([["Three results remain unexplained. ",true],["Block size does not act monotonically on accuracy, with block shape the leading hypothesis. Stochastic rounding does not outperform round to nearest, the opposite of Croci and Giles for the parabolic heat equation. Quantising less frequently has not been swept."]]));
...
c.push(bulletm([["Explain the anomalies. ",true],["Test block shape against the non monotonic block size result, and sweep the quantisation interval to see how far suppressing accumulation lowers the safe bit width."]]));
